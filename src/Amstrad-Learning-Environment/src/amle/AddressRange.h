...
/** \file AddressRange.h
 * \brief This file only contains the structure AddressRange, more information on its structure doc.
 */

/**
 * This structure represents a range within the memory.
 * This is useful as soon as the data that needs to be found in memory is
 * more than a byte long. 
 */
typedef struct {
