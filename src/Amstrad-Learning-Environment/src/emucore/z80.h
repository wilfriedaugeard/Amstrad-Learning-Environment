...
/** 
 * @brief Copy of read_mem method that can be used in the AmLE.
 * This copy is not inline, therefore it is less efficient but it won't be used often.
 * @param addr: The address of the byte to get.
 * @return Returns the required byte
 **/
byte amle_public_read_mem(word addr);
